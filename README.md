...
Editor for icons stored in ICN format files.

Created in 1992 for use on softwares developed in [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal) for MS-Dos.
